...
def get_all_training_data(labeling_fn, norm_field_fn, field_count, max_field_size, stride):
    ...
    into list of nodes
    :return: A tuple (x_data,y_target) of ndarrays. x_data has shape (s,field_count,field_size,n)
    ...
    for item in dir(fetch_training_data):
        ...
        if callable(attribute) and attribute.startswith('get'):
            ...
            for fields_list in receptive_fields_groups:
                ...
                y_target_list.append(current_target)
